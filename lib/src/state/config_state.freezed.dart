...
/// @nodoc
mixin _$ConfigState {
  BuildFlavor get mode => throw _privateConstructorUsedError;
  @JsonKey(toJson: toJsonLocale, fromJson: fromJsonLocale)
...
abstract class $ConfigStateCopyWith<$Res> {
  ...
  $Res call(
      {BuildFlavor mode,
      @JsonKey(toJson: toJsonLocale, fromJson: fromJsonLocale) Locale locale});
}
...
class _$ConfigStateImpl with DiagnosticableTreeMixin implements _ConfigState {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ConfigState(mode: $mode, locale: $locale)';
  }
...
abstract class _ConfigState implements ConfigState {
  const factory _ConfigState(
      {required final BuildFlavor mode,
      @JsonKey(toJson: toJsonLocale, fromJson: fromJsonLocale)
      required final Locale locale}) = _$ConfigStateImpl;
